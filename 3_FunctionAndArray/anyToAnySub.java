import java.util.*;
  ...
  public static void main(String[] args) {
      ...
      int d = getSubtract(b, n1, n2);
      System.out.println(d);
   } 
   
   public static int getSubtract(int b, int n1, int n2){
       // write ur code here
        int temp1 = anyBaseToDecimal(n1 , b);  // first convert both to decimal Base
        int temp2 = anyBaseToDecimal(n2 , b);  
        int sub = (temp1 > temp2) ? (temp1 - temp2) : (temp2 - temp1) ;      // then subtract  them 
        return ( (decimalToAnyBase(sub, b) ) ); // then again convert to result to sourceBase
